...
;背景変更
[back storage="room.jpg" method=slide time=5000]
...
[iscript]
f.preload_images_op = ["data/bgimage/room.jpg?2222","data/bgimage/rouka.jpg?3333","data/bgimage/entrance.jpg?4444","data/bgimage/toile.jpg?6666"];
[endscript]
...
;登場キャラクターの定義
[chara_new name="yuko" storage="f047.png" jname="ゆうこ"]
[chara_new name="haruko" storage="f169.png" jname="はるこ"]
...
;[button graphic="button_title_cg.gif" storage="title.ks" fix="true" target="*click_button" fix=true x=200 y=300 enterse="phone_take.mp3"]
;[button graphic="button_title_cg.gif" storage="scene1.ks" fix="true" target="*test" x=200 y=400 ]
...
[locate x=300 y=100]
[clickable width=100 height=100 border="solid:1px:gray" target=*oda2]
...
;キャラクター登場
[chara_show time="3000" name="yuko"]
